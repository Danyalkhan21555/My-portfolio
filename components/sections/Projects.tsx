      ...
      <div className="container-custom">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
          ...
          <div className="hidden md:block">
            <div className="text-sm font-bold uppercase tracking-widest text-primary/50">
              Scroll to Explore (02)
            </div>
          </div>
        </div>
            ...
            >
              ...
              <TiltCard className="w-full md:w-3/5">
                <div className="relative aspect-[16/10] overflow-hidden rounded-[2.5rem] glass-card border-white/5 group-hover:border-white/20 transition-all duration-700 shadow-2xl shimmer-effect">
                  ...
                  {/* Overlay on hover */}
                  <div className="absolute inset-x-0 bottom-0 p-8 translate-y-full group-hover:translate-y-0 transition-transform duration-500 bg-gradient-to-t from-dark-900 to-transparent">
                    <div className="flex gap-4">
                      <a
                        href={project.githubUrl}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="p-3 bg-white/10 backdrop-blur-md rounded-full hover:bg-white/20 transition-all focus:ring-2 focus:ring-primary outline-none"
              ...
              <div className="w-full md:w-2/5 space-y-6">
                <div className="flex items-center gap-4">
                  <span className="text-primary font-black text-sm tracking-widest uppercase">0{index + 1}</span>
                  <div className="h-[1px] w-12 bg-primary/30" />
                </div>
                <h3 className="text-3xl md:text-5xl font-black group-hover:text-primary transition-colors">
                  {project.title}
                </h3>
                ...
                <div className="flex flex-wrap gap-3">
                  {project.technologies.map(tech => (
                    <span key={tech} className="px-5 py-2 glass-card rounded-full text-xs font-bold uppercase tracking-wider border-white/5">
                      {tech}
                    </span>
                  ))}
                </div>
